...
export async function preassessmentValidator(
  ...
  const schema = joi.object({
    	"How old are you?": joi.string().optional(),
    "What level of education are you currently in?": joi.string().optional(),
    "Have you used a study assistant app before?": joi.string().optional(),
    "How did you hear about SIMBI?": joi.string().optional(),
    "What do you hope to achieve with SIMBI?": joi.string().optional(),
    "What's your preferred way of studying?": joi.string().required(),
    ...
    "What are your current learning goals?": joi.string().required().min(10),
    "How often would you like SIMBI to check in on your progress?": joi
      .string()
      .required(),
  });
